...
export const BOARDING_POLICIES = new Set(['fixed_stop_only','terminal_or_stand_only','main_road_pass_through','hail_along_segment','unknown_do_not_assume','fixed_only','corridor_hail','corridor_request','mixed']);
