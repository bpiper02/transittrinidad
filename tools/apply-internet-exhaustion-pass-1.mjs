...
const carenageAssoc=src('Guardian: Carenage Taxi Drivers Association confirms POS/Carenage service in both directions','https://www.guardian.co.tt/news/pos-to-carenage-taxi-fare-to-rise-diego-martin-drivers-feel-unsafe-6.2.1842043.43be95556c','2023-11-02');
const mafekingOrder=src('MOWT Traffic Control Mayaro/Mafeking Taxi Stand Order','https://www.mowt.gov.tt/Divisions/Administrative-Supporting-Units/Legal-Service-Unit/Legal-Notices/Legal-Notice-263','2021-10-21');
const mafekingMap=src('OpenStreetMap-derived Mafeking community location','https://www.openstreetmap.org/node/7824185572');
const tobagoFare=src('Newsday: West-End Taxi Association Crown Point fare increase','https://newsday.co.tt/2022/02/24/tobago-taxi-fares-to-increase-by-1-from-march-15/','2022-02-24');
...
if(services.some(x=>x.id==='scarborough-crown-point-taxi-to-crown-point-area')) patchId('scarborough-crown-point-taxi-to-crown-point-area',{fareTTD:10,fareConfidence:'community_verified',serviceConfidence:'community_verified'},tobagoFare);
...
upsert(nodes,{id:'carenage-route-taxi-area',name:'Carenage route-taxi service area',kind:'stop_zone',location:{lat:10.6881668,lng:-61.5928155},locationConfidence:'approximate_area',boardingNote:'Carenage town-area endpoint for the documented Port of Spain/Carenage route. Exact Carenage-side stand or turnaround still needs local confirmation.',sources:[carenageAssoc,carenageStand,carenageLegal,src('OpenStreetMap contributors: Carenage','https://www.openstreetmap.org/node/1822868093')]});
for(const [id,from,to] of [['taxi-pos-to-carenage','maxi-pos-western-hub','carenage-route-taxi-area'],['taxi-carenage-to-pos','carenage-route-taxi-area','maxi-pos-western-hub']]) upsert(services,{id,corridorId:'taxi-pos-carenage',mode:'route_taxi',operator:'Carenage Taxi Drivers Association / local route taxis',originNodeId:from,destinationNodeId:to,stopNodeIds:[from,to],serviceConfidence:'community_verified',geometryConfidence:'endpoints_only',geometry:null,fareTTD:null,fareConfidence:'unknown',scheduleConfidence:'unknown',sources:[carenageAssoc,carenageStand,carenageLegal],boardingNote:'Carenage Taxi Drivers Association evidence confirms service in both directions. Exact Carenage-side stand and current 2026 fare still need confirmation.'});

upsert(nodes,{id:'mafeking-area',name:'Mafeking route-taxi area',kind:'stop_zone',location:{lat:10.30345,lng:-61.02082},locationConfidence:'approximate_area',boardingNote:'Approximate Mafeking village area derived from the mapped community centre; exact taxi turnaround/stand needs local confirmation.',sources:[mafekingOrder,mafekingMap]});
upsert(services,{id:'taxi-mayaro-to-mafeking',corridorId:'taxi-mayaro-mafeking',mode:'route_taxi',operator:'Local route taxis',originNodeId:'maxi-mayaro',destinationNodeId:'mafeking-area',stopNodeIds:['maxi-mayaro','mafeking-area'],serviceConfidence:'verified_service',geometryConfidence:'endpoints_only',geometry:null,fareTTD:null,fareConfidence:'unknown',scheduleConfidence:'unknown',sources:[mafekingOrder,mafekingMap],boardingNote:'MOWT formally designates a Mayaro/Mafeking taxi stand. Mafeking endpoint is approximate until the village-side stand is confirmed. Reverse service is not inferred.'});
