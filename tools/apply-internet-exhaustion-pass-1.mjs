...
const route2Fare=src('Newsday: Route 2 Maxi fare adjustment','https://newsday.co.tt/2021/10/07/route-two-maxi-taxi-fares-to-increase-on-nov-1/','2021-10-07');
...
// Current-ish association/news fare evidence. Where a corridor has both directions, apply the same published direct fare to both represented directions.
...
patchCorridor('maxi-san-fernando-la-brea',{fareTTD:15,fareConfidence:'community_verified'},pointFare);
...
// Strengthen source evidence even where the fare model is not safely flat.
...
// Official stand/lane evidence for southeast hubs.
...
// Last disconnected tracked place: connect Carenage honestly as an approximate service-area endpoint. We have a documented POS-side Carenage taxi route, but not a surveyed Carenage-side stand.
